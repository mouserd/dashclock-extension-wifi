## <img src="res/drawable-ldpi/ic_launcher.png"> DashClock Wifi Extension

[DashClock Wifi Extension](https://play.google.com/store/apps/details?id=com.pixelus.dashclock.ext.wifi) 
...
This extension displays your devices current Wifi status on the DashClock widget and even allows you to 
toggle it on/off just by tapping the extension.

Specifically, this extension allows you to:
+ Easily see your current wifi status (enabled, enabling, disabled, disabling)
+ Easily see your active wifi connection details and signal strength
+ Toggle your current Wifi status with one tap
...
`target/wifi-signed-aligned.apk` is then ready for upload into the playstore.  To initiate a new release, simply:
